...
const Headers = () => {
    return (
        ...
        <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-semibold text-[#f5f5f5]">Maria Gracia</h1>
        </div>

        {/* SEARCH */}
        <div className="flex items-center gap-4 bg-[#1f1f1f] rounded-[20px] px-5 py-2 w-[500px]">
            <FaSearch className="text-[#f5f5f5] gap-2" />
            <input 
            type="text" 
            placeholder="Search" 
        ...
        <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col items-start">
                <h1 className="text-md text-[#f5f5f5] font-semibold">Andres Anni</h1>
